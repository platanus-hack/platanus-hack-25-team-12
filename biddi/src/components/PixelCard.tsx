...
export default function PixelCard({
  ...
  return (
    <div
      ref={containerRef}
      className={`relative overflow-hidden border border-[#27272a] rounded-2xl isolate transition-colors duration-200 ease-[cubic-bezier(0.5,1,0.89,1)] select-none ${className}`}
